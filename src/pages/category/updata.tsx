...
import { getById, updatecategory } from "../../api/category";
import { useEffect } from "react";
import { categoryFrom } from "../../models";
import { categorySchame } from "../../models";
...
const UpdataCategory = () => {
    const { register, handleSubmit, formState: { errors } } = useForm<categoryFrom>({
        resolver: yupResolver(categorySchame),
        defaultValues: async () => {
            if (id) {
